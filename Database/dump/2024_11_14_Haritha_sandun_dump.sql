...
-- Dumping data for table feelfresh_db.brand: ~4 rows (approximately)
...
-- Dumping data for table feelfresh_db.category: ~3 rows (approximately)
...
-- Dumping data for table feelfresh_db.category_has_brand: ~2 rows (approximately)
...
-- Dumping data for table feelfresh_db.gender: ~2 rows (approximately)
...
-- Dumping data for table feelfresh_db.status: ~2 rows (approximately)
...
-- Dumping data for table feelfresh_db.user: ~1 rows (approximately)
INSERT INTO `user` (`nic`, `first_name`, `last_name`, `email`, `reg_date`, `password`, `no`, `line1`, `line2`, `status_id`, `user_type_id`, `gender_id`) VALUES
...
-- Dumping data for table feelfresh_db.user_type: ~3 rows (approximately)
