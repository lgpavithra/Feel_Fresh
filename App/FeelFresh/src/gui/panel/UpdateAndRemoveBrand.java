 ...
 * @author PC
 */
public class UpdateAndRemoveBrand extends javax.swing.JPanel {

    private final Brand brand_vp;
    String currentBrand_vp;

    /**
     * Creates new form UpdateAndRemoveBrand
     */
    public UpdateAndRemoveBrand(Brand b) {
        initComponents();
        this.brand_vp = b;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        } else if (uJTextfield1.getText().equals(currentBrand_vp)) {
            JOptionPane.showMessageDialog(this, "Brand is already up to date", "Information", JOptionPane.INFORMATION_MESSAGE);
        } else {
            try {
    ...
    private void uJTextfield1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_uJTextfield1KeyReleased
        if (!uJTextfield1.getText().equals(currentBrand_vp)) {
