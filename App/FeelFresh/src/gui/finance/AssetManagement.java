...
public class AssetManagement extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        assetValue.setFont(new java.awt.Font("Poppins", 0, 30)); // NOI18N
        assetValue.setForeground(new java.awt.Color(255, 255, 255));
        assetValue.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        assetValue.setText("00.00");
            ...
            .addGroup(panalRound1Layout.createSequentialGroup()
                ...
                .addGroup(panalRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panalRound1Layout.createSequentialGroup()
                        ...
                        .addGap(0, 93, Short.MAX_VALUE))
                    .addComponent(assetValue, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        if (name.isEmpty()) {
            JOptionPane.showMessageDialog(assetManagement, "name cannot be null", "warning", JOptionPane.WARNING_MESSAGE);
            return;
        } else if (value.isEmpty()) {
            JOptionPane.showMessageDialog(assetManagement, "value cannot be null", "warning", JOptionPane.WARNING_MESSAGE);
            return;
        } else if (!isValidDouble(value)) {
            JOptionPane.showMessageDialog(assetManagement, "value must be a valid number", "warning", JOptionPane.WARNING_MESSAGE);
            return;
        } else {
            FinanceDTO dTO = DTOGenerator.getInstance().generateFinanceDTO(name, "Asset", Double.parseDouble(value));
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            String msg = FinanceDepartment.getAssetManager().update(name, Double.parseDouble(value));
            if (msg.equals("successfully updated")) {
                JOptionPane.showMessageDialog(assetManagement, "Updated successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(assetManagement, "Unknown Error occured", "warning", JOptionPane.WARNING_MESSAGE);
            }
            loadTable();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        FinanceDepartment.getAssetManager().delete(name);
        loadTable();
        loadValues();
    ...
    public JLabel getAssetValue() {
        return assetValue;
    }

    private void loadValues() {
        getAssetValue().setText(String.valueOf(FinanceDepartment.getAssetManager().getValue()));
    }

    private void loadTable() {
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);
        ResultSet rs = FinanceDepartment.getAssetManager().read();
        try {
            while (rs.next()) {
